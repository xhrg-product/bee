...
public abstract class ChannelKey {
    ...
    public static final AttributeKey<Channel> CHANNEL_BACK_KEY = AttributeKey.valueOf("CHANNEL_BACK_KEY");

    public static final AttributeKey<Channel> CHANNEL_FRONT_KEY = AttributeKey.valueOf("CHANNEL_FRONT_KEY");
