...
CREATE TABLE `bee_router`  (
  ...
  `target_Url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '目标地址',
...
-- ----------------------------
INSERT INTO `bee_router` VALUES (1, 'http', 'http://127.0.0.1:20000/bee-demo/query', 1);
